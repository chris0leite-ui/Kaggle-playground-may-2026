...
submissions_used_today: 1         # 1/9 Day-15 (2026-05-06 15:38: d15b_path_b_K22_dae_only_tau20000 LB 0.95059 +1bp NEW PRIMARY; realised amp 1.4× on +0.715bp OOF lift, well below Path-B-amp 6-11.6× central; new friction `path-b-amp-only-fires-on-meta-arch-not-base-add`)
submissions_used_total: 26
...
mechanism_families_explored:
  ...
  - alpha_tau_resweep_d15a          # d15 Branch A -- α-asymmetry hypothesis (fold-train counts in OOF, full-train at test); FALSIFIED. τ=20000 with full-train α produces ρ=1.000000 vs d13e PRIMARY (literally identical). At segments ≥1000 rows, α=n/(n+τ)≈1 in both regimes; smaller τ values regress (τ=2000 -0.99bp). Calibration is already at optimum; gap is mechanism-bound.
...
plateau_days: 0                   # Day-15 PM PRIMARY-advance to LB 0.95059 (DAE-class new-base +1bp); plateau reset.
