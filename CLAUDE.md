...
submissions_used_today: 3         # 2026-05-06: (1) K=22 Path B d12_lr_meta τ=100k LB 0.95045 -4bp REGRESS [main-branch]; (2) K=22 LR-meta + d15_orig_transfer LB 0.95039 -10bp REGRESS [decode branch, meta-arch confound]; (3) K=22 hier-meta + d15_orig_transfer LB 0.95049 TIE [decode branch, HEDGE-eligible]
submissions_used_total: 27
...
plateau_days: 3                   # Day-13/14 alt-axis branch: 4-of-4 nulls (G1/G2'/G3/H1). Path B was Day-13 structural win on meta-layer axis; partition-shape Day-13 PM saturated across 6 shapes; d14 cohort sweep extends Path B null.
