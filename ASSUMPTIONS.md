...
| A30 | The 3-D logit subspace of the K=10 / K=27 pool is the **information ceiling of the 14-feature row-level data under the LR-meta family**. Breaking it requires either (i) data beyond the 14 columns, or (ii) a non-LR meta architecture | FALSIFIED | dropped | A29 + A25 + EXP-2/3/4 NULL motivated this. **2026-05-08 PM (research-model-extensions-Ibwvn) directly tested option (ii):** GBM meta on K=4 [P, rank, logit] regressed −1.20 bp; 2-hidden-layer MLP meta regressed −7.77 bp; augmented LR with raw row features flat at −0.04 bp. Non-LR meta is NOT the unblocker — it overfits the 30-feature meta projection on a 1.33-D logit pool (A31). The information ceiling is real but the route around it is not "non-LR meta." Audit: `audit/2026-05-08-four-lane-research-extension.md`, `scripts/artifacts/probe_lane4_nonlr_meta.json` | 2026-05-08 |
