...
| A27 | OOF → LB transfer at this pool's modeling scale is **precise** (within ±0.1 bp), even though the absolute public-split CI is ±12 bp wide | MEASURED | live (NEW) | A26 single-submission datapoint plus prior A2 bootstrap CI. Implies: relative comparisons between submissions of the same model class are tight; absolute LB level is sampled noisily | 2026-05-08 |
