...
Outputs:
  oof_d17_path_b_K22_h1d_yekenot_tau{tau}_strat.npy
  test_d17_path_b_K22_h1d_yekenot_tau{tau}_strat.npy
  d17_path_b_K22_h1d_yekenot_results.json
"""
...
def main():
    ...
    for src_oof, src_test in [
        ...
        ("oof_d17_h1d_yekenot_full_strat.npy", "test_d17_h1d_yekenot_full_strat.npy"),
    ]:
    ...
    for tau in taus:
        ...
        np.save(ART / f"oof_d17_path_b_K22_h1d_yekenot_tau{tau}_strat.npy",
                np.column_stack([1 - oof, oof]))
        np.save(ART / f"test_d17_path_b_K22_h1d_yekenot_tau{tau}_strat.npy",
    ...
    (ART / "d17_path_b_K22_h1d_yekenot_results.json").write_text(
        json.dumps(final, indent=2))
    print(f"\n→ scripts/artifacts/d17_path_b_K22_h1d_yekenot_results.json  "
