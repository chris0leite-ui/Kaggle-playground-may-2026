...
add d15b_lgbm_dae_only as the 22nd base in the pool. d15b_lgbm_dae_only
...
Outputs:
  oof_d15b_path_b_K22_dae_only_tau{tau}_strat.npy
  test_d15b_path_b_K22_dae_only_tau{tau}_strat.npy
  d15b_path_b_K22_dae_only_results.json
"""
...
def main():
    ...
    for src_oof, src_test in [
        ...
        ("oof_d15b_lgbm_dae_only_strat.npy", "test_d15b_lgbm_dae_only_strat.npy"),
    ]:
    ...
    for tau in taus:
        ...
        np.save(ART / f"oof_d15b_path_b_K22_dae_only_tau{tau}_strat.npy",
                np.column_stack([1 - oof, oof]))
        np.save(ART / f"test_d15b_path_b_K22_dae_only_tau{tau}_strat.npy",
    ...
    (ART / "d15b_path_b_K22_dae_only_results.json").write_text(
        json.dumps(final, indent=2))
    print(f"\n→ scripts/artifacts/d15b_path_b_K22_dae_only_results.json  "
